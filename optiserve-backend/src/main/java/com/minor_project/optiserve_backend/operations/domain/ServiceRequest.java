...
public class ServiceRequest {
    ...
    private ServiceRequest(Vehicle vehicle, ServiceType serviceType, PriorityClass priorityClass, Instant appointmentAt) {
    ...
    public static ServiceRequest create(
        ...
        return new ServiceRequest(null, serviceType, priorityClass, appointmentAt);
    }
